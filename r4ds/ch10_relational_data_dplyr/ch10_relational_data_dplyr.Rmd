...
![img4](./image/img4.png){width="200"}  

실제 조인에서는 매치 항목이 점으로 표시됨  
(점 수 = 매치 수 = 출력 행 수)  
![img5](./image/img5.png){width="400"}

### 4-2. 내부 조인
inner join: 키가 같을 때마다 두 관측값을 매칭함  
![img6](./image/img6.png){width="400"}
...
![img7](./image/img7.png){width="400"}  

벤 다이어그램으로 서로 다른 유형의 조인 묘사하기  
![img8](./image/img8.png){width="400"}   
...
![img10](./image/img10.png){width="400"}  
```{r}
y <- tribble(
   ~key, ~val_y,
   1, "y1",
...
![img14](./image/img14.png){width="400"}  
...
![img15](./image/img15.png){width="400"}  
